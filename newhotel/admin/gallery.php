		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					<form action="addgalleryexec.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
							...
							while($row = mysqli_fetch_array($result))
								{
									...
									echo '<td style="border-left: 1px solid #C1DAD7;"><img src="../images/fullscreen/'.$row['image'].'" width="100" height="80"></td>';
