			...
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							include('connect.php');
							$result = mysqli_query("SELECT * FROM reservation ORDER BY firstname ASC");
							while($row = mysqli_fetch_array($result))
								{
									...
									$results = mysqli_query("SELECT * FROM rooinventory where confirmation='$rrr'");
									while($row1 = mysqli_fetch_array($results))
										{
										$roomid=$row1['room'];
										$resulta = mysqli_query("SELECT * FROM internet_shop where id='$roomid'");
