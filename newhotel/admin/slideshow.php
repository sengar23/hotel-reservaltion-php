		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				<ul class="radius-top clearfix" id="main-menu">
					...
					<li>
						<a href="gallery.php">
							<img alt="Gallery" src="img/m-gallery.png">
							<span>Gallery</span>
						</a>
					</li>
					<li>
						<a class="active" href="slideshow.php">
							<img alt="Files" src="img/m-files.png">
							<span>Slideshow</span>
						</a>
					</li>
					<li>
				...
				<div id="content" class="clearfix">
					<form action="addslideexec.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
					 Room Image: <br /><input type="file" name="image" class="ed">
					 <input type="submit" name="Submit" value="save" id="button1" />
					</form>
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> Image </th>
								<th> Action </th>
							</tr>
						</thead>
						<tbody>
						<?php
							...
							$result = mysqli_query("SELECT * FROM slideshow");
							while($row = mysqli_fetch_array($result))
								{
									echo '<tr class="record">';
									echo '<td style="border-left: 1px solid #C1DAD7;"><img src="../images/slider/'.$row['image'].'" width="100" height="80"></td>';
