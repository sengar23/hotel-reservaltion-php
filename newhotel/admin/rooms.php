			...
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							include('connect.php');
							$result = mysqli_query("SELECT * FROM internet_shop");
							while($row = mysqli_fetch_array($result))
								{
									echo '<tr class="record">';
									echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['name'].'</td>';
									echo '<td><div align="right">'.$row['price'].'</div></td>';
									echo '<td><div align="right">'.$row['room_number'].'</div></td>';
									echo '<td><div align="right">'.$row['description'].'</div></td>';
									echo '<td><a rel="facebox" href="editroomimage.php?id='.$row['id'].'"><img src="../reservation/img/products/'.$row['img'].'" width="80" height="50"></a></td>';
									echo '<td><div align="center"><a rel="facebox" href="editroomdetails.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
